...
/**
 * Script file of Apisv plugin
 */
class plgsystemPapisvInstallerScript
{
        ...
        {
                $deletelist = array();
                $plugin_path = JPATH_PLUGINS . '/system/apisv';
                ...
                {
                        $delete = [
                                $admin_lang_path . '/en-GB/en-GB.plg_system_apisv.sys.ini',
                                $admin_lang_path . '/en-GB/en-GB.plg_system_apisv.ini',
                                $site_lang_path . '/en-GB/en-GB.plg_system_apisv.ini',
                        ];
